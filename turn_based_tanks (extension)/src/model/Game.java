...
public class Game implements ObstacleListener, TankActionListener {
    ...
    private void determineWinner(Obstacle deadHeadquartersOrTank) {
        int winTeam = -1;
    ...
    private void changeTankActivity(boolean status) {
        _isTankActive = status;
    ...
    public void bulletFlewOut(BulletEvent event) {
        event.bullet().addObstacleListener(this);
        changeTankActivity(false);
